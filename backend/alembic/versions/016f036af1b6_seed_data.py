...
stmt = (
    ...
    "(12, 'Electric Company', 150, 'utility', Null, 'vacant'), "
    ...
    "(17, 'Community Chase', 0, 'draw-chest', Null, 'vacant'), "
    ...
    "(28, 'Water Works', 150, 'utility', Null, 'vacant'), "
...
card_stmt = (
    "INSERT INTO cards (id, title, type, is_gooj) VALUES "
    "(1, 'Advance to Go (Collect $200)', 'community-chest', false), "
    "(2, 'From sale of stock, you get $45', 'community-chest', false), "
    "(3, 'You inherit $100', 'community-chest', false), "
    "(4, 'Pay hospital $100', 'community-chest', false), "
    "(5, 'Grand Opera Opening. Collect $50 from every player for opening night seats.', "
    "'community-chest', false), "
    "(6, 'Income Tax Refund. Collect $20', 'community-chest', false), "
    "(7, 'Receive for services, $20', 'community-chest', false), "
    "(8, 'Doctor Fee. Pay $50', 'community-chest', false), "
    "(9, 'Go to jail. Go directly to jail. Do not pass go. Do not collect $200', "
    "'community-chest', false), "
    "(10, 'Bank error in your favor. Collect $200', 'community-chest', false), "
    "(11, 'Xmas fund matures. Collect $100', 'community-chest', false), "
    "(12, 'Life insurance matures. Collect $100', 'community-chest', false), "
    "(13, 'Get out of jail free. (This card may be kept until needed, or sold)', "
    "'community-chest', true), "
    "(14, 'Pay School tax of $150', 'community-chest', false), "
    "(15, 'You have won 2nd price in a beauty contest. Collect $10', 'community-chest', false), "
    "(16, 'You are assessed for street repairs. $40 per house, $115 per hotel', "
    "'community-chest', false), "
    "(17, 'You have been elected chairman of the board. Pay each player $50', 'chance', false), "
    "(18, 'Your building and loan matures. Collect $150', 'chance', false), "
    "(19, 'Get out of jail free. This card may be kept until needed, or sold', 'chance', true), "
    "(20, 'Bank Pays you dividend of $50', 'chance', false), "
    "(21, 'Pay poor tax of $15', 'chance', false), "
    "(22, 'Take a ride on the Reading. If you pass go, collect $200', 'chance', false), "
    "(23, 'Advance to go (Collect $200)', 'chance', false), "
    "(24, 'Advance to St. Charles Place. If you pass go, collect $200', 'chance', false), "
    "(25, 'Go back 3 spaces', 'chance', false), "
    "(26, 'Take a walk on the Boardwalk. Advance token to Boardwalk', 'chance', false), "
    ...
    " throw dice and pay owner a total ten times the amount thrown', 'chance', false), "
    "(30, 'Advance to Illinois Ave', 'chance', false), "
    "(31, 'Go directly to jail. Do not pass GO. Do not collect $200', 'chance', false), "
    "(32, 'Make general repairs on all your property. For each house pay $25, "
    "for each hotel $100', 'chance', false)"
)
